...
def classic_soft(observation_space, action_space):
    encoder_f = em.encoder_simple_dense
    
    actor = am.actor_soft_dense(observation_space, action_space, encoder_f)

    critic = cm.critic_dense_iqn(observation_space, action_space, encoder_f)

    return actor, critic

def classic_soft_naive(observation_space, action_space):
    encoder_f = em.encoder_simple_dense
...
def unity_soft_res_iqn(observation_space, action_space):
    encoder_f = em.encoder_simple_res
